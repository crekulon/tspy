...
* Enforced Morale
  - Is now a targeted AoE, deals damage to anything in the affected area including friends, foes, and the caster. increased movement speed bonuses, can now slot run speed IOs
...
* Painbringer
  - Reworked to a targeted AoE that grants a damage buff to friendlies, you and the main target gain a damage resistance buff if targeting a friend, resistance increased for each additional target in the area, enemies recieve a resistance debuff instead with the main target reciving a larger resistance debuff that stacks per target hit.
